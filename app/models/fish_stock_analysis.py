...
graph_stocks(excel_file=r"C:\Users\beñat.egidazu\Desktop\NAS\PhD\Papers\Fisheries_2\Data_nca\stocks\stockinfo4Benat.xlsx",
             ...
             x="Year",
             x_label="Year",
            #  y=["ReproductiveCapacity", "RecruitmentRatio", "RelativeGrowth", "SustainableFoodProvisioning", "SustainableExploitation", "GoodEnvironmentalStatus"],
            y=["ReproductiveCapacity", "RecruitmentRatio", "RelativeGrowth", "SustainableExploitation", "GoodEnvironmentalStatus"],
             y_label= "Indicator Value",
             color = ['green', "orange", "blue", "red", "brown"],
             year_column="Year",
             year_range=(2000,2020),
             title="Trachurus trachurus Stock Indicators in Division 9a",
             figsize=(12, 6),
             show_plot=False,
             save_path=os.path.join(r"C:\Users\beñat.egidazu\Desktop\NAS\PhD\Papers\Fisheries_2\Results\Graphs\hom.27.9a", "trachurus_trachurus_9aS_indicators.png")
            )
